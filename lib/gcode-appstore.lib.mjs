    ...
    let pagebody = new Div({
        ...
        children: [
            ...
            new Div({
                ...
                "margin": "auto",
                "width": "350px",
                innerHTML: "<p style=\"font-size:30px;font-weight: bold;\">" + params.appName + "</p><p style=\"font-size:24px;font-weight: bold;\">About thiis app</p><p>" + params.appDescription+"</p>"
            }),
            new Div({
