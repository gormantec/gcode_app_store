    ...
    let pagebody = new Div({
        ...
        children: [
            new Div({
                ...
                "margin": "auto",
                "width": "350px",
                innerHTML: "<img width=\"80px\" \"height\" \"80px\" src="+params.app192Logo+"></img><div style=\"display:inline-block\"><p style=\"font-size:32px;font-weight: 600;\">" + params.appName + "</p><p style=\"margin-top:4px\"><a href=\"https://www.gormantec.com\">gormantec</a></p></div><p style=\"font-size:20px;font-weight: 600;\">About thiis app</p><p>" + params.appDescription+"</p>"
            }),
            new Div({
