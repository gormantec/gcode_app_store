...
export function showAppPageFromId(params) {

    console.log("show " + params.APPID);
    if (params.APPID) {
        console.log("show " + params.APPID);
        (async () => {
            console.log("show " + params.APPID);
            ...
            for (let i = 0; i < jsn.data.length; i++) {
                if (jsn.data[i].scope) {
                    let id = jsn.data[i].scope ? jsn.data[i].scope.replace(/\/apps\/(.*?)\//ig, "$1") : jsn.data[i].appName.replace(" ", "-");
                    console.log(id);
                    if (id == params.APPID) {
...
export function showAppPage(params) {

    let pagebody = new Div({
        position: "relative",
        children: [
            new Div({
                "tagName": "p",
                ...
                "margin": "auto",
                "width": "350px",
                innerHTML: "<img width=\"80px\" \"height\" \"80px\" src="+params.app192Logo+"></img><div style=\"display:inline-block\"><p style=\"font-size:38px;font-weight: 600; margin:4px;\">" + params.appName + "</p><p style=\"margin:4px\"><a href=\"https://www.gormantec.com\">gormantec</a></p></div><div style=\"overflow:scroll;height:200px;background-color:#AAAAAA;margin:10px;white-space: nowrap;\"><img style=\"padding:4px\" height=\"250\" src=\"/images/screenshot001.png\"><img style=\"padding:4px\" height=\"250\" src=\"/images/screenshot001.png\"><img style=\"padding:4px\" height=\"250\" src=\"/images/screenshot001.png\"><img style=\"padding:4px\" height=\"250\" src=\"/images/screenshot001.png\"><img style=\"padding:4px\" height=\"250\" src=\"/images/screenshot001.png\"><img style=\"padding:4px\" height=\"250\" src=\"/images/screenshot001.png\"></div><p style=\"font-size:20px;font-weight: 600;\">About this app</p><p>" + params.appDescription+"</p>"
            }),
            new Div({
                position: 'relative',margin: "auto","height":"40px",paddingTop:"20px", "width": "340px", children: [new Div({
                    "id": "open",
                    "onclick": () => {
                    ...
                    position: 'relative',
                }), new Div({ position: 'relative',display: "inline-block", color:"black",paddingLeft:"10px",innerText: "Open as a webapp" })]
            })
        ]
    });
    ...
    if (params.apkLocation) {
        pagebody.appendChild(new Div({
            position: 'relative',margin: "auto","height":"40px",  "width": "340px", children: [new Div({
                "id": "apk",
            ...
            }), new Div({ position: 'relative',display: "inline-block", color:"black",paddingLeft:"10px",innerText: "Install the Android App" })]
        }));
    }
    if (params.ipaLocation) {
        ...
        pagebody.appendChild(new Div({
            position: 'relative',margin: "auto", "height":"40px",  "width": "340px", children: [new Div({
                ...
                "innerText": "iOS",
                "display": "inline-block",position: 'relative',
            }), new Div({ position: 'relative',display: "inline-block", color:"black",paddingLeft:"10px",innerText: "Install the Apple App" })]
        }));
    }
    console.log("setPage:" + params.scope);
