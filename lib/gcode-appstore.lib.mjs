    ...
    let pagebody = new Div({
        ...
        children: [
            ...
            new Div({
                ...
                }), new Div({ display: "inline-block", color:"black",innerText: "Open Web App" })]
            })
        ]
    });
    ...
    if (params.apkLocation) {
        pagebody.appendChild(new Div({
            position: 'relative',"height":"40px",  "width": "340px", children: [new Div({
                ...
                "innerText": "APK",
                "display": "inline-block",
            }), new Div({ display: "inline-block", color:"black",innerText: "Install the Android App" })]
        }));
    }
    if (params.ipaLocation) {
        ...
        pagebody.appendChild(new Div({
            position: 'relative',"height":"40px",  "width": "340px", children: [new Div({
                ...
                "innerText": "iOS",
                "display": "inline-block",
            }), new Div({ display: "inline-block", color:"black",innerText: "Install the Apple App" })]
        }));
    }
