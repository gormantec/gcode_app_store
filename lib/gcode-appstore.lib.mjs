    ...
    let pagebody = new Div({
        ...
        children: [
            new Div({
                ...
                "margin": "auto",
                "width": "350px",
                innerHTML: "<p style=\"font-size:30px;font-weight: bold;\"><img width=\"50px\" \"height\" \"50px\" src="+params.app192Logo+"></img>" + params.appName + "</p><p style=\"font-size:24px;font-weight: bold;\">About thiis app</p><p>" + params.appDescription+"</p>"
            }),
            new Div({
