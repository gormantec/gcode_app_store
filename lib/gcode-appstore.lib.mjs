    ...
    let pagebody = new Div({
        ...
        children: [
            new Div({
                ...
                "margin": "auto",
                "width": "350px",
                innerHTML: "<img width=\"80px\" \"height\" \"80px\" src="+params.app192Logo+"></img><div style=\"display:inline-block\"><p style=\"font-size:38px;font-weight: 600; margin:4px;\">" + params.appName + "</p><p style=\"margin:4px\"><a href=\"https://www.gormantec.com\">gormantec</a></p></div><div style=\"height:200px;background-color:#AAAAAA;margin:10px;\"></div><p style=\"font-size:20px;font-weight: 600;\">About this app</p><p>" + params.appDescription+"</p>"
            }),
            new Div({
