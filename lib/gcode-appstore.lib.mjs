...
export function showAppPage(params) {
    ...
    let pagebody = new Div({
        ...
        children: [
            ...
            new Div({
                position: 'relative',"height":"60px", "width": "350px", children: [new Div({
                    "id": "open",
                    "onclick": () => {
                    ...
                    position: 'relative',
                }), new Div({ position: 'relative',display: "inline-block", color:"black",innerText: "Open Web App" })]
            })
        ]
    });
    ...
    if (params.apkLocation) {
        pagebody.appendChild(new Div({
            position: 'relative',"height":"40px",  "width": "340px", children: [new Div({
                "id": "apk",
            ...
            }), new Div({ position: 'relative',display: "inline-block", color:"black",innerText: "Install the Android App" })]
        }));
    }
    if (params.ipaLocation) {
        ...
        pagebody.appendChild(new Div({
            position: 'relative',"height":"40px",  "width": "340px", children: [new Div({
                ...
                "innerText": "iOS",
                "display": "inline-block",position: 'relative',
            }), new Div({ position: 'relative',display: "inline-block", color:"black",innerText: "Install the Apple App" })]
        }));
    }
