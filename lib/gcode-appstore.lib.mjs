    ...
    let pagebody = new Div({
        ...
        children: [
            ...
            new Div({
                ...
                }), new Div({ display: "inline-block", innerText: "Open Web App" })]
            })
        ]
    });
    ...
    if (params.apkLocation) {
        pagebody.appendChild(new Div({
            "height":"60px",  "width": "340px", children: [new Div({
                ...
                "innerText": "APK",
                "display": "inline-block",
            }), new Div({ display: "inline-block", innerText: "Install the Android App" })]
        }));
    }
    if (params.ipaLocation) {
        ...
        pagebody.appendChild(new Div({
            "height":"60px",  "width": "340px", children: [new Div({
                ...
                "innerText": "iOS",
                "display": "inline-block",
            }), new Div({ display: "inline-block", innerText: "Install the Apple App" })]
        }));
    }
