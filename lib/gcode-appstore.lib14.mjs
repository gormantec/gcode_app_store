            ...
            for (let k = 0; k < manifests.length; k++) {
                ...
                try {
                    ...
                    if (fileMD5z[fileMD5] == null && resText2 != null) {
                        ...
                        resText2.ipa_location = "itms-services://?action=download-manifest&url="+APP_NAME+"/ios/"+APP_NAME+".plist";
                        ...
                        if (apkLocation && apkLocation != null) {
                            ...
                            try {
                                ...
                                if (res3.ok && res3.headers.get('content-type').indexOf("application") >= 0) {
                                    console.log("xxx.data.push: 1");
                                    resText2.apk_location = apkLocation2;
                                    xxx.data.push(resText2);
                                }
                                else {
                                    console.log("xxx.data.push: 2 "+res3.ok+" "+res3.headers.get('content-type'));
                                    xxx.data.push(resText2);
                                }
                            }
                            catch (e) {
                                console.log("e: " + e);
                                console.log("xxx.data.push: 3");
                                xxx.data.push(resText2);
                            }
                        }
                        else {
                            console.log("xxx.data.push: 4");
                            xxx.data.push(resText2);
                        }
                    }
                } catch (e) { }
