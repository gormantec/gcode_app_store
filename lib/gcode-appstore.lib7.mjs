...
class App extends Div {
    constructor(params) {
        super({
            ...
            fontSize: "x-small",
            children: [
                new Div({ "tagName": "center", "position": "static", "child": new Div({ 
                    "tagName": "img",
                    "onclick": ()=>{PWA.getPWA().setPage(new Page({"child":new Div({"innerHTML":"test"})}))},
                    "position": "static", "src": params.app192Logo, "width": "100px", "height": "100px" }) }),
                new Div({ "tagName": "p", "position": "static","overflow": "hidden", "height": "75px","margin":"0px", "innerHTML": "<b>" + params.appName + "</b>: " + params.appDescription }),
