...
class App extends Div {
    constructor(params) {
        ...
        if (params.ipaLocation) {
            this.appendChild(new Div({ "id": "iOS", "onclick": () => { console.log("click"); window.location.href = params.ipaLocation; }, "position": "absolute", "bottom": "2px", "left": "40px", "backgroundColor": "black", "borderRadius": "4px", "width": "26px", "height": "12px", "padding": "2px", "paddingLeft": "4px", "paddingRight": "4px", "color": "white", "textAlign": "center", "innerText": "iOS" }));
        }
    }
}
