...
class App extends Div {
    constructor(params) {
        super({
            ...
            padding: "5px",
            fontSize: "x-small",
            innerHTML: "<center><img src=\"" + params.app192Logo + "\" width=100 height=100></center><p><b>" + params.appName + "</b>: " + params.appDescription + "</p><div style=\"position:absolute;bottom:2px;left:2px;background-color:blue;border-radius:4px;padding:2px;padding-left:4px;padding-right:4px;color:white\">Open</div><div style=\"position:absolute;bottom:2px;left:35px;background-color:orange;border-radius:4px;padding:2px;padding-left:4px;padding-right:4px;color:white\">APK</div><div style=\"position:absolute;bottom:5px;right:5px\">" + params.appStars + "</div>",
