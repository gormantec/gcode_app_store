...
class App extends Div {
    constructor(params) {
        super({
            ...
            fontSize: "x-small",
            children: [
                new Div({"tagName":"center","child":new Div({"tagName":"img","src":params.app192Logo })}),
                new Div({"tagName":"p","innerHTML":"<b>" + params.appName + "</b>: " + params.appDescription }),
                new Div({"id":"open", "position":"absolute","bottom":"2px","left":"2px","backgroundColor":"blue","borderRadius":"4px","width":"26px","height":"12px","padding":"2px","paddingLeft":"4px","paddingRight":"4px","color":"white","innerText":"Open"}),
                new Div({"id":"apk", "position":"absolute","bottom":"2px","left":"40px","backgroundColor":"orange","borderRadius":"4px","width":"26px","height":"12px","padding":"2px","paddingLeft":"4px","paddingRight":"4px","color":"white","innerText":"APK"})   
            ],
