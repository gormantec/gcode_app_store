    ...
    constructor(params) {
        super({
            ...
            children: [
                ...
                new Div({"id":"open", "position":"absolute","bottom":"2px","left":"2px","backgroundColor":"blue","borderRadius":"4px","padding":"2px","paddingLeft":"4px","paddingRight":"4px","color":"white","innerText":"Open"}),
                new Div({"id":"apk", "position":"absolute","bottom":"2px","left":"40px","backgroundColor":"orange","borderRadius":"4px","padding":"2px","paddingLeft":"4px","paddingRight":"4px","color":"white","innerText":"APK"})   
            ],
