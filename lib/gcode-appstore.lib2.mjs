...
class App extends Div {
    constructor(params) {
        super({
            ...
            padding: "5px",
            fontSize: "small",
            innerHTML: "<center><img src=\"" + params.app192Logo + "\" width=160 height=160></center><p><b>" + params.appName + "</b>: " + params.appDescription + "</p><div style=\"position:absolute;bottom:5px;left:5px;background-color:blue;border-radius:8px;padding:4px;padding-left:8px;padding-right:8px;color:white\">Open</div><div style=\"position:absolute;bottom:5px;right:5px\">" + params.appStars + "</div>",
