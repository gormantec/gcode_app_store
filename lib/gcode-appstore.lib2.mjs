...
class App extends Div {
    constructor() {
        super({
            ...
            padding: "5px",
          	fontSize: "small",
            innerHTML: "<center><img src=\"https://gcode.com.au/images/boatcrew/boat-logo-blue-icon192x192.png\" width=160 height=160></center><p><b>boat crew</b>: Invite or meet new freinds. Pubich a trip and find a boat crew. Or search for a trip that needs a crew in your area.</p><div style=\"position:absolute;bottom:5px;left:5px;background-color:rgb(19, 138, 114,0.5);border-radius:8px;padding:4px;padding-left:8px;padding-right:8px;color:white\">Install</div><div style=\"position:absolute;bottom:5px;right:5px\">****</div>",
