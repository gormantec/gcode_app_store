                ...
                (async () => {
                    ...
                    for (let i = 0; i < list.length && i<100; i++) {
                        ...
                        if (list2 && list2.length > 0) {
                            for (let j = 0; j < list2.length  && j<500; j++) {
                                if(j>maxJ)maxJ=j;
                                asynCalls++;
...
await seachGoogle("https://www.microsoft.com/en-au/store/top-free/apps/pc");
await seachGoogle("https://www.microsoft.com/en-au/store/best-rated/apps/pc");
await seachGoogle("https://www.microsoft.com/en-au/store/most-popular/apps/pc");
