                                            ...
                                            for (let k = 0; k < manifests.length; k++) {
                                                try {
                                                    ...
                                                    if(fileMD5z[fileMD5]==null && resText2!=null && resText2.lang!="fa-IR" && resText2.lang!="fa" && !contain_persian_char(resText2.name))
                                                    {
                                                        ...
                                                        var apkLocation = resText2.root_uri.replace("/manifest.json", "/apk/app-release-signed.apk");
                                                        if(apkLocation.endsWith("app-release-signed.apk"))resText2.apk_location=apkLocation;
